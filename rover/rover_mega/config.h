...
// mechanics / encoders
constexpr float    enc_pulses_per_rev = 753.2f / 4; // Four "events", see ds
constexpr float    enc_gear_ratio     = 26.9f;  // Encoder shaft vs. motor shaft
...
// motor PWM pins
constexpr uint8_t left_pwm_fwd  = 3;
constexpr uint8_t left_pwm_rvs  = 4;
constexpr uint8_t right_pwm_fwd = 7;
constexpr uint8_t right_pwm_rvs = 6;
constexpr uint8_t driver_pins[4] = { 
    left_pwm_fwd, left_pwm_rvs, right_pwm_fwd, right_pwm_rvs 
};
...
constexpr int     safe_dist_cm = -100;
