...
class Lidar:
    ...
    CRCTABLE = [
        ,
    ...
    def process_packet(self, p, show=0, motor_angle=0):	#data comes in as LSB then MSB
    ...
    def print_pts(self, pts, cartesian=0):
        for pt in pts:
            print("%c: " % 'C' if cartesian else 'P', end='')
            print("%f, %f, I=%d" % (pt[0], pt[1], pt[2]))


    def print_scan_data(data):
    ...
    def write_pts_to_file(self, filename, pts): #this should be split into multiple functions
        with open(filename, "a") as file:
            for pt in pts:
                file.write("%s %s %s %s\n" % (pt[0], pt[1], pt[2], pt[3]))
