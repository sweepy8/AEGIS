...
class Motor:
    ...
    def __init__(self):
        ...
        self.step   = gpz.OutputDevice(pin=5, initial_value=False)		# Step signal on GPIO 5 (pin 29)
    ...
    @param dir: A string representing the direction of turn ("CW" or "CCW"). 
    @return: None
    '''
    ...
    @param f: Correction factor multiplier
    @return: None
    '''
